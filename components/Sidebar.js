        ...
        <div className="sidebar_dashboard">
          <ul className="nav flex-column">
            <li className="nav-item">
              <Link
                href="/dashboard"
                className={`nav-link d-flex ${activeLink === "dashboard" ? "active" : ""}`}
                onClick={() => setActiveLink("dashboard")}
              >
                <MdDashboard style={{ fontSize: "2rem", marginLeft: "0.5rem" }} />
            ...
            <li className="nav-item">
              <Link
                href="/hotels"
                className={`nav-link d-flex ${activeLink === "hotels" ? "active" : ""}`}
                onClick={() => setActiveLink("hotels")}
              >
                <img
                  src="/images/gaming-control 1.png"
                  alt="logo-hotel"
                  className="logo_hotel ms-2"
                />
                <p style={{ marginLeft: "0.6rem", paddingTop: "0.3rem", fontSize: "11.5px" }}>
                  Liste des hôtels
                </p>
              </Link>
            </li>
